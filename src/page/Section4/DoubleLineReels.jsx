...
export const DoubleLineReels = () => {
  const images = [
    ...
    PojectImg5,
    PojectImg6,
    "https://marketlube-website-assets.s3.ap-south-1.amazonaws.com/hawksee/choice3_igjcn5+(2).jpg",
    "https://marketlube-website-assets.s3.ap-south-1.amazonaws.com/hawksee/daya3_rbb5tb+(2).jpg",
    "https://marketlube-website-assets.s3.ap-south-1.amazonaws.com/hawksee/dubai2_jm6kzc+(2).jpg",
    "https://marketlube-website-assets.s3.ap-south-1.amazonaws.com/hawksee/image_sifi2s+(2).jpg",
    Branding12,
    Branding14,
  ];
